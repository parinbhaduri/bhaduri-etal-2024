...
disamenity_abms = [BaltSim(;slr_scen=slr_scen, no_of_years=no_of_years, perc_growth=perc_growth, house_choice_mode=house_choice_mode, flood_coefficient=i, levee=false,
...
pop_disam = Plots.plot(adf_dis.step, flood_pop_change, group = adf_dis.ensemble, ls = :solid,
  label = ["-10³" "0" "-10⁵" "-10⁷"], legend = :topleft, leg_title = "Coefficients", lw = 2.5, dpi = 300)
